...
import static com.puttipob.stock_backend.security.SecurityConstants.EXPIRATION_TIME;
	...
	protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain,
		...
		if (authResult.getPrincipal() != null) {
			...
			if (username != null && username.length() > 0) {
				Claims claims = Jwts.claims().setSubject(username).setIssuer("RyuRew")
						.setAudience("www.github.com/puttipob");
